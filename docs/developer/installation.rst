...
This module is a frontend for :doc:`OpenWISP RADIUS
<https://github.com/openwisp/openwisp-radius>`.

So in order to use it, this app needs a running instance of OpenWISP
RADIUS and an organization correctly configured, you can obtain this by
...
You can access the application at http://localhost:80808/default/login/
...
3. ``OPENWIPS_RADIUS_PATH`` environment variable is needed to setup/tear
   down the database data needed to run the browser tests. This can be set
